...
A = int(1000 * 2**2 * 10000)
gamma = int(6.5e-5 * 1e18)
D = 2 * 10**18
N = 2
dp = 1e-8
dx = 1e-5
...
if __name__ == '__main__':
    import pylab
    d_price = np.linspace(-60e-2, 60e-2, 1000)
    ...
    pylab.semilogy(d_price, f_liq_density(int(5000 * 2**2 * 10000), int(1e-4 * 1e18))(d_price), '--')
    pylab.show()
